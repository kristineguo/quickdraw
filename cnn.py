...
"""Convolutional Neural Network Estimator for Quick Draw, built with tf.layers."""
...
def cnn_model_fn(features, labels, mode):
  ...
  # Output Tensor Shape: [batch_size, 345]
  logits = tf.layers.dense(inputs=dropout, units=345)
...
def main(unused_argv):
  ...
  classifier = tf.estimator.Estimator(
      model_fn=cnn_model_fn, model_dir="/tmp/quickdraw_convnet_model")
